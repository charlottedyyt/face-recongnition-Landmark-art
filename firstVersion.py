...
for face_landmarks in face_landmarks_list:
    ...
    d.polygon(shifted_top_lip_list, fill=(255, 67, 67, 1000))
    d.polygon(shifted_bottom_lip_list, fill=(255, 67, 67, 1000))
    d.line(top_lip_list, fill=(0, 46, 210, 1000), width=5)
    d.line(bottom_lip_list, fill=(0, 46, 210, 1000), width=5)
